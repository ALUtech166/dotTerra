<template>
  <div class="font-sans tw-flex tw-flex-col tw-opacit-90">
    ...
    <header>
      <nav
        class="font-sans tw-shadow-lg tw-mx-auto tw-flex tw-flex-wrap tw-gap-4 tw-px-8 tw-lg:justify-evenly tw-justify-between tw-items-center tw-py-6">
        <div>
          <nuxt-link to="/">
            <h1 class="tw-text-4xl tw-font-extrabold tw-text-green-600">
              DotTerra
            </h1>
          </nuxt-link>
        ...
        <ul
          class="tw-tracking-wide tw-font-medium tw-w-full tw-block tw-flex-grow lg:tw-space-x-8 tw-space-y-6 lg:tw-space-y-0 lg:tw-flex lg:tw-flex-initial lg:tw-w-auto tw-items-center tw-mt-8 lg:tw-mt-0"
          ...
          <button @click="$router.push('/try-now')"
            class="tw-group tw-relative tw-border-2 tw-h-12 tw-mt-4 tw-cursor-pointer hover:tw-transform hover:tw-translate-x-2 hover:tw-transition-transform hover:tw-duration-300 hover:tw-shadow-green-600 tw-border hover:tw-shadow-lg tw-w-48 tw-overflow-hidden tw-rounded-lg tw-bg-white tw-text-lg tw-shadow-2xl">
            <div
      ...
      <div class="tw-relative tw-w-full tw-h-full tw-p-12 tw-pb-4 tw-bg-black tw-bg-opacity-80">
        ...
        <v-row class="">
          ...
          <v-col  class="tw-text-left tw-mt-8" cols="12" md="3" lg="3">
            <nuxt-link to="/">
            <h1 class="tw-text-4xl tw-font-extrabold tw-mb-4 tw-text-green-600">
              DotTerra
            </h1>
          </nuxt-link>
